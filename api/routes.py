...
import pandas as pd
from explainers.demo import get_demo_examples, explain_prediction, generate_analyst_report, load_demo_components
...
# Add this route to your existing api_blueprint
@api_blueprint.route('/demo', methods=['GET'])
def demo_page():
    """API endpoint to get demonstration examples"""
    try:
